    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="header-top-user ">
                        ...
                        <div class="dropdown mini-menu" id="mini-menu">
                            ...
                            <ul class="dropdown-menu" id="sub-menu-login">
                                <li class="dropdown-item"><a class="dropdown-item" href="infor">Trang Cá Nhân</a></li>
                                <li class="dropdown-item"><a class="dropdown-item" href="#">Tin Đã Đăng</a></li>
                ...
                @else
                <div class="pull-right">
                    <a class="btn btn-submit-room pull-left" data-toggle="modal" data-target="#modal_auth" href="javascript: void(0);">Đăng tin miễn phí</a>
